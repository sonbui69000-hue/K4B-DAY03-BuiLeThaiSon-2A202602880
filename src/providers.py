...
class OpenRouterProvider(BaseLLMProvider):
    """OpenRouter Provider dùng OpenAI-compatible API endpoint."""
    def __init__(self, api_key: str = None, model: str = None):
        self.api_key = api_key or os.getenv("OPENROUTER_API_KEY")
        self.model_name = model or os.getenv("LLM_MODEL") or "openrouter/free"
        ...
        try:
            ...
            if msg.tool_calls:
                ...
                return {
                    ...
                    "tool_name": call.function.name,
                    "arguments": args,
                    "thought": f"OpenRouter quyết định gọi công cụ '{call.function.name}' với tham số: {json.dumps(args, ensure_ascii=False)}"
                }
            else:
                return {
                    "type": "text",
